...
public:
    ...
    void dequeueLast() {
       ...
       // Kasus 1: Hanya ada satu elemen
        if (queue.head->next == nullptr) {
            string dequeueData = queue.head->data; // Ambil data sebelum dihapus
            delete queue.head; // Hapus node
            queue.head = nullptr;
            queue.front = nullptr;
            queue.end = nullptr;
            jumlahData--;
            cout << "Dequeued (Last): " << dequeueData << endl;
        }
        // Kasus 2: Ada lebih dari satu elemen
            ...
            string dequeueData = queue.end->data; // Ambil data sebelum dihapus
            delete queue.end; 
            queue.end = current; 
    ...
    void displayQueue1() {
        ...
        while (current != nullptr) {
            cout << "  [" << count++ << "] Data: " << setw(10) << left << current->data;
    ...
    void displayQueue2() {
        cout << "\n=======================================" << endl;
        cout << "        STATUS QUEUE [Reversed]        " << endl;
        cout << "=======================================" << endl;
